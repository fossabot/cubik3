<template>
    <div>
        ...
        <input class="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded shadow-sm focus:outline-none focus:z-10 dark:bg-ngray-800 dark:text-gray-100 dark:placeholder-gray-400"
            :class="{
